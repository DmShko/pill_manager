      ...
      <div className={cd.courses}>
        ...
        <div className={cd.searchContainer}>
          ...
          <div className={cd.coursesDrive}>
            <button className={cd.coursesButton} title="Add new course" id='add' type='button' disabled={detectSelected() !== 0 ? true : false}><Add onClick={openAddBoard} style={addButtonStyle()} width={'30px'} height={'30px'} stroke={detectSelected() !== 0 ? 'lightgray' : '#646cff'}/></button>
