...
const Process = (props: React.SVGProps<SVGSVGElement>) => { 
    return (
      <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-beetwen'}}>
          <svg height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
                viewBox="0 0 392.533 392.533" xmlSpace="preserve" {...props}>
            ...
            <path style={{fill: '#56ACE0'}} d="M196.299,91.281L196.299,91.281c-30.642,0-55.467,24.824-55.467,55.467v138.02
                ...
                "/>
            <g>
                <path style={{fill: '#FFC10D'}} d="M172.638,152.436h-25.083c-6.012,0-10.925,4.848-10.925,10.925c0,6.012,4.848,10.925,10.925,10.925
                    h25.083c6.012,0,10.925-4.848,10.925-10.925C183.564,157.349,178.715,152.436,172.638,152.436z"/>
                <path style={{fill: '#FFC10D'}} d="M172.638,197.43h-25.083c-6.012,0-10.925,4.848-10.925,10.925c0,6.012,4.848,10.925,10.925,10.925
                    h25.083c6.012,0,10.925-4.848,10.925-10.925S178.715,197.43,172.638,197.43z"/>
                <path style={{fill: '#FFC10D'}} d="M172.638,242.424h-25.083c-6.012,0-10.925,4.848-10.925,10.925c0,6.077,4.848,10.925,10.925,10.925
