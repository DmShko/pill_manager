...
const Memory = (props: React.SVGProps<SVGSVGElement>) => { 
    return (
      <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-beetwen'}}>
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
            viewBox="0 0 392.534 392.534" xmlSpace="preserve" {...props}>
            <rect x="121.869" y="21.851" style={{fill: '#56ACE0'}} width="208.485" height="269.317"/>
